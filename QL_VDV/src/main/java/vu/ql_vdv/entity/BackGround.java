...
public class BackGround implements Serializable {
    ...
    public BackGround(Integer IDBackGround, long maVDV, String monThiDau, String hoTen, String gioiTinh, Date thoiGianTapLuyen, String tuyenVDV, String hlvPhuTrach, String dangCapVDV) {
    ...
    public Date getThoiGianTapLuyen() {
        return thoiGianTapLuyen;
    }

    public void setThoiGianTapLuyen(Date thoiGianTapLuyen) {
        this.thoiGianTapLuyen = thoiGianTapLuyen;
    }
